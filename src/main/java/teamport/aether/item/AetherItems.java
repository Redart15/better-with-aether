...
public final class AetherItems {
    ...
    public static void registerOther() {
        ...
        EGG_MOA_WHITE = new Item("egg.moa.white", itemKey("egg_moa_white"), itemID("EGG_MOA_WHITE"))
            .setMaxStackSize(16);

        EGG_MOA_BLACK = new Item("egg.moa.black", itemKey("egg_moa_black"), itemID("EGG_MOA_BLACK"))
            .setMaxStackSize(16);
        ...
        LIFESHARD = new ItemLifeShard("food.lifeshard", itemKey("food_lifeshard"), itemID("LIFESHARD"))
            .setMaxStackSize(10);
        ...
        SIGN_SKYROOT = new ItemSignSkyroot("sign.skyroot", itemKey("sign_skyroot"), itemID("SIGN_SKYROOT"), false);
        SIGN_SKYROOT_PAINTED = new ItemSignSkyroot("sign.skyroot.painted", itemKey("sign_skyroot_painted"), itemID("SIGN_SKYROOT_PAINTED"), true);
        ...
        AMMO_WINDBALL = new Item("ammo.windball", itemKey("ammo_windball"), itemID("AMMO_WINDBALL"))
            .withTags(ItemTags.NOT_IN_CREATIVE_MENU);

        PROJECTILE_FIRE = new Item("projectile.fire", itemKey("projectile_fire"), itemID("PROJECTILE_FIRE"))
            .withTags(ItemTags.NOT_IN_CREATIVE_MENU, ItemTags.IS_FIRE_PROOF);

        PROJECTILE_ICE = new Item("projectile.ice", itemKey("projectile_ice"), itemID("PROJECTILE_ICE"))
            .withTags(ItemTags.NOT_IN_CREATIVE_MENU);
